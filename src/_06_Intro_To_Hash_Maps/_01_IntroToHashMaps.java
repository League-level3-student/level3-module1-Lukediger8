...
public class _01_IntroToHashMaps {
    public static void main(String[] args) {
        // 1. Create a HashMap called roots with Integers for the keys and Doubles for the values.
    	  HashMap<Integer, Double> skibidi = new HashMap<Integer, Double>();
        ...
        //    square roots (values). Use the following format.
    	  for(Integer key : skibidi.keySet()) {
    		  Double value = skibidi.get(key);
    		  System.out.println("The Square Root" + key + "is" + value);
    	  }
